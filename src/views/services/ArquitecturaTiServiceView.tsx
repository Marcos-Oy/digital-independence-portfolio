...
import arqHero from "@/assets/services/arq-hero.jpg";
...
import arqCta from "@/assets/services/arq-cta.jpg";
            ...
            <ScrollReveal delay={120} variant="scale" className="relative">
              <div className="relative pt-6 pr-4 pb-6 pl-4">
                ...
                <BlobImage
                  src={arqHero}
                  shape={2}
                  alt="Equipo de consultoría TI diseñando la arquitectura tecnológica de una empresa en una oficina moderna y luminosa"
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollReveal delay={120} variant="scale" className="relative">
              <ServicePhoto src={arqResultado} alt="Equipo de negocio trabajando con confianza sobre una base tecnológica gobernada" shape={2} />
            </ScrollReveal>
          </div>
        </div>
      </section>
            ...
            <ScrollReveal delay={120} variant="scale">
              <div className="relative pt-6 pr-4 pb-6 pl-4">
                ...
                <BlobImage
                  src={arqCta}
                  shape={4}
                  alt="Profesional agendando un diagnóstico de arquitectura tecnológica en una oficina luminosa"
                  className="w-full aspect-[4/3] shadow-card-hover"
                />
                <RingLoop color="secondary" className="absolute -bottom-2 -left-2 w-24 h-24" />
                <AccentBlob shape={6} color="secondary" className="absolute bottom-4 right-4 w-7 h-5 opacity-80" />
