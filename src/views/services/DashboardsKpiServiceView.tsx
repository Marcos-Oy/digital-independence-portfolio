...
const KpiRow = ({ icon: Icon, label, defined = true }: { icon: React.ComponentType<{ className?: string; strokeWidth?: number }>; label: string; defined?: boolean }) => (
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-20 overflow-hidden bg-background">
        ...
        <div className="relative container mx-auto px-4">
          <div className="flex flex-wrap items-center gap-1.5 text-xs text-muted-foreground mb-10">
            ...
            <span>/</span>
            <span className="text-foreground">Dashboards y KPI</span>
          </div>
