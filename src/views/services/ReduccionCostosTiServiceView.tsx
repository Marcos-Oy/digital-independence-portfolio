...
const InventoryRow = ({ icon: Icon, label, contracted, used, flagged = false }: { icon: React.ComponentType<{ className?: string }>; label: string; contracted: number; used: number; flagged?: boolean }) => (
