...
const ChatBotView = () => {
  ...
  return (
    <>
      ...
      {/* Chat window */}
      {open && (
        <div style={kbStyle} className="fixed z-50 flex flex-col overflow-hidden animate-fade-in bg-card border border-border shadow-xl rounded-2xl bottom-24 left-4 right-4 h-[70vh] max-h-[calc(100vh-8rem)] md:left-auto md:right-6 md:w-[360px] md:h-[500px] md:max-h-[calc(100vh-8rem)]">
          {/* Header */}
