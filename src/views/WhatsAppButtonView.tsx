import { buildWhatsAppLink } from "@/models/whatsapp";

const WhatsAppButtonView = () => {
  const href = buildWhatsAppLink("Hola, quiero más información sobre Independencia Digital");
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-24 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
...
export default WhatsAppButtonView;
