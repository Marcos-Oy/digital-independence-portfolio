...
const landings = [
  { title: "Landing General", desc: "Vista completa del programa Independencia Digital con todas las fases.", href: "/landing/general", icon: Layers, badge: "General" },
  { title: "Arquitectura TI", desc: "Cimientos: orden de cuentas, correos, archivos y accesos.", href: "/landing/arquitecturati", icon: Server, badge: "Fase 1" },
  { title: "Presencia Digital", desc: "Sitio web profesional y redes sociales con estrategia.", href: "/landing/presenciadigital", icon: Users, badge: "Fase 2" },
  { title: "Ciberseguridad", desc: "Protección de datos, contraseñas, backups y verificación.", href: "/landing/ciberseguridad", icon: Shield, badge: "Fase 3" },
  { title: "Analítica Aplicada", desc: "Tableros de control y decisiones basadas en datos.", href: "/landing/analiticaaplicada", icon: BarChart3, badge: "Fase 4" },
  { title: "IA y Automatización", desc: "Automatiza ventas, tareas y reportes con IA segura.", href: "/landing/inteligenciaartificial", icon: Brain, badge: "Fase 5" },
];
