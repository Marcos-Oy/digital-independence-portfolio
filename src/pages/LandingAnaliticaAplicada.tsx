...
const LandingAnaliticaAplicada = () => (
  <PhaseLandingLayout
    phaseNum={4}
    title="Analítica Aplicada"
    subtitle="Decisiones"
    img={fase4}
    heroHeadline="Toma Decisiones con Datos, no con Intuición"
    heroDesc="Convierte tus datos en decisiones claras y accionables mediante tableros de control en tiempo real, sin necesidad de conocimientos avanzados."
    whatIs="En esta fase te enseñamos a entender y aprovechar los datos que tu negocio ya genera. Configuramos tableros de control visuales con Power BI o Google Data Studio, conectamos tus fuentes de datos (sitio web, redes sociales, ventas) y te enseñamos a interpretar métricas clave."
    benefits={[
...
export default LandingAnaliticaAplicada;
