...
4. **Ciberseguridad**:
   - **Ciberseguridad: Gestión y Estrategia**: dirección de seguridad (gestión de riesgos, pólizas de ciberseguro, gobierno de datos, cumplimiento Ley 21.663 y 21.719, ISO 27001, gestión de incidentes y de presupuesto), más ejecución técnica: MFA, antivirus, respaldo de datos, bloqueo de puertos USB, directivas de grupo (GPO/Active Directory), seguridad de aplicaciones/DevSecOps (login seguro, protección contra inyección SQL y XSS, búsqueda de vulnerabilidades), monitoreo con SIEM/SOC/SOAR, capacitaciones, simulacros de phishing y de ciberdelito corporativo, y ciberseguridad diferencial (protección digital para niños/adolescentes y para mujeres). Al final del diagnóstico se entrega una hoja de ruta de servicios profesionales a contratar.
